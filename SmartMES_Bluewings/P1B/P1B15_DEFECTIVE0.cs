...
{
    public partial class P1B15_DEFECTIVE0 : SmartMES_Bluewings.FormBasic
    {
        public P1B15_DEFECTIVE0()
        {
            InitializeComponent();
        }
        private void P1B15_DEFECTIVE0_Load(object sender, EventArgs e)
        {
        ...
        private void dataGridView1_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            //P1B15_DEFECTIVE0_SUB sub = new P1B15_DEFECTIVE0_SUB();
        ...
        private void pbPrint_Click(object sender, EventArgs e)
        {
            ...
            string reportFileName = "SmartMES_Bluewings.Reports.P1B15_DEFECTIVE0.rdlc";
