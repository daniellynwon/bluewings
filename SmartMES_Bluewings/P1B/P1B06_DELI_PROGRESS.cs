...
{
    public partial class P1B06_DELI_PROGRESS : SmartMES_Bluewings.FormBasic
    {
        ...
        public async void ListSearch()
        {
            try
            {
                ...
                var data = dataSetP1B.SP_Progress_Query;
        ...
        private void pbPrint_Click(object sender, EventArgs e)
        {
            ...
            string reportFileName = "SmartMES_Bluewings.Reports.P1B06_DELI_PROGRESS.rdlc";
