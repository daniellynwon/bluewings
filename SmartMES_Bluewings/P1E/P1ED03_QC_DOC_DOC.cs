...
namespace SmartMES_Bluewings
{
    public partial class P1ED03_QC_DOC_DOC : Form
    {
        ...
        public P1ED03_QC_DOC_DOC()
        {
            InitializeComponent();
        }

        private void P1ED03_QC_DOC_DOC_Load(object sender, EventArgs e)
        {
        ...
        private void P1ED03_QC_DOC_DOC_FormClosing(object sender, FormClosingEventArgs e)
        {
            Cv.ReleaseImage(src);
        ...
        private void btnDel_Click(object sender, EventArgs e)
        {
            ...
            {
                con.Open();
                string sql = "UPDATE tb_quality_doc SET doc" + sNo + " = NULL, doc" + sNo + "_size = 0, doc" + sNo + "_name = null WHERE docdata_no = '" + sParentCode + "'";
