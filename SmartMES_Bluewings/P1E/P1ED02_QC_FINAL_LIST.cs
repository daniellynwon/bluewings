...
{
    public partial class P1ED02_QC_FINAL_LIST : SmartMES_Bluewings.FormBasic
    {
        ...
        public async void ListSearch()
        {
            try
            {
                ...
                var data = dataSetP1E.SP_QcFinalList_Query;
        ...
        private void pbPrint_Click(object sender, EventArgs e)
        {
            ...
            string reportFileName = "SmartMES_Bluewings.Reports.P1ED02_QC_FINAL_LIST.rdlc";
