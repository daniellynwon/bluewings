...
{
    public partial class P1ED04_MOLD_MOVE_DOC : Form
    {
        public P1ED04_MOLD_MOVE parentWin;       
        public string sNo;
        ...
        public P1ED04_MOLD_MOVE_DOC()
        {
            InitializeComponent();
        }
        private void P1ED04_MOLD_MOVE_DOC_Load(object sender, EventArgs e)
        {
        ...
        private void P1ED04_MOLD_MOVE_DOC_FormClosing(object sender, FormClosingEventArgs e)
        {
            Cv.ReleaseImage(src);
        ...
        private void btnDel_Click(object sender, EventArgs e)
        {
            ...
            {
                con.Open();
                string sql = "UPDATE tb_mold_move SET doc" + sNo + " = NULL, doc" + sNo + "_size = 0, doc" + sNo + "_name = null WHERE mold_id = '" + sParentCode + "''";
