...
{
    public partial class P1ED04_MOLD_SUB_DOC : Form
    {
        public P1ED04_MOLD_SUB parentWin;       
        public string sNo;
        ...
        public P1ED04_MOLD_SUB_DOC()
        {
            InitializeComponent();
        }
        private void P1ED04_MOLD_SUB_DOC_Load(object sender, EventArgs e)
        {
        ...
        private void P1ED04_MOLD_SUB_DOC_FormClosing(object sender, FormClosingEventArgs e)
        {
            Cv.ReleaseImage(src);
        ...
        private void btnDel_Click(object sender, EventArgs e)
        {
            ...
            {
                con.Open();
                string sql = "UPDATE tb_mold_info SET doc" + sNo + " = NULL, doc" + sNo + "_size = 0, doc" + sNo + "_name = null WHERE mold_id = '" + sParentCode + "''";
