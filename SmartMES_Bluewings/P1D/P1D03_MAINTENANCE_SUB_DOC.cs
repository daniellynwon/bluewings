...
{
    public partial class P1D03_MAINTENANCE_SUB_DOC : Form
    {
        public P1D03_MAINTENANCE_SUB parentWin;       
        public string sNo;
        ...
        public P1D03_MAINTENANCE_SUB_DOC()
        {
            InitializeComponent();
        }
        private void P1D03_MAINTENANCE_SUB_DOC_Load(object sender, EventArgs e)
        {
        ...
        private void ImageLoad()
        {
            ...
            string sql = "SELECT doc" + sNo + ", doc" + sNo + "_size, doc" + sNo + "_name " +
                "from tb_machine_repair " +
                "where machine_id = '" + sParentCode + "'";
        ...
        private void P1D03_MAINTENANCE_SUB_DOC_FormClosing(object sender, FormClosingEventArgs e)
        {
            Cv.ReleaseImage(src);
        ...
        private void btnDel_Click(object sender, EventArgs e)
        {
            ...
            {
                con.Open();
                string sql = "UPDATE tb_machine_repair SET doc" + sNo + " = NULL, doc" + sNo + "_size = 0, doc" + sNo + "_name = null WHERE machine_id = '" + sParentCode + "'";
